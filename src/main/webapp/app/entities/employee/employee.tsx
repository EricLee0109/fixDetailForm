  ...
  return (
    <div>
      <h2 id="employee-heading" data-cy="EmployeeHeading">
        <Translate contentKey="bookingCarApiApp.employee.home.title">Danh sách nhân viên</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="bookingCarApiApp.employee.home.refreshListLabel">Làm mới danh sách</Translate>
          </Button>
          <Link to="/employee/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="bookingCarApiApp.employee.home.createLabel">Tạo mới 1 nhân viên</Translate>
          </Link>
        </div>
      </h2>
        ...
        {employeeList && employeeList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="bookingCarApiApp.employee.id">ID</Translate>
                </th>
                <th>
                  Tên nhân viên
                </th>
                <th>
                  <Translate contentKey="bookingCarApiApp.employee.gender">Giới tính</Translate>
                </th>
                {/* <th>
                  <Translate contentKey="bookingCarApiApp.employee.imageUrl">Image Url</Translate>
                </th> */}
                <th>
            ...
            <tbody>
              {employeeList.map((employee, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{employee.showroom ? <Link to={`/show-room/${employee.showroom.id}`}>{employee.showroom.address}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bookingCarApiApp.employee.home.notFound">Không tìm thấy nhân viên</Translate>
            </div>
          )
        )}
      </div>
