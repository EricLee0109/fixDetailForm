  ...
  return (
    <div>
      <h2 id="customer-heading" data-cy="CustomerHeading">
        <Translate contentKey="bookingCarApiApp.customer.home.title">Danh sách khách hàng</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="bookingCarApiApp.customer.home.refreshListLabel">Làm mới danh sách</Translate>
          </Button>
          <Link to="/customer/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="bookingCarApiApp.customer.home.createLabel">Tạo mới 1 khách hàng</Translate>
          </Link>
        </div>
      </h2>
        ...
        {customerList && customerList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="bookingCarApiApp.customer.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="bookingCarApiApp.customer.username">Username</Translate>
                </th>
                <th>
                  <Translate contentKey="bookingCarApiApp.customer.phone">Số điện thoại</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bookingCarApiApp.customer.home.notFound">Không tìm thấy khách hàng</Translate>
            </div>
          )
        )}
      </div>
